const web3 = Moralis.web3ByChain("0x61"); // Mumbai Testnet

const nft_market_place_address = "0x2e266f562048ad4ab2C1D490AE8caCAA51424ea1" ;
...
Moralis.Cloud.define("placeOffering", async(request) => {
	const hostContract = request.params.hostContract;
 	...
 	const tokenId = request.params.tokenId;
  	...
  	const nonceOperator = web3.eth.getTransactionCount("0x5d095B324dF85C3610aEF8886eF272c6DcB6D6c5")
